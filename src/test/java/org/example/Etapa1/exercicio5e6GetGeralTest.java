...
public class exercicio5e6GetGeralTest {
    ...
    public void testaListaTodosAsTarefas() throws Exception {
        ...
        try (OutputStream os = conn.getOutputStream()) {
            os.write(novaTarefaJson.getBytes(StandardCharsets.UTF_8));
        }

        assertEquals(201, conn.getResponseCode());
        conn.disconnect();

        URL urlGet = new URL("http://localhost:" + porta + "/tarefas");
        ...
        assertTrue(jsonResposta.startsWith("["));
